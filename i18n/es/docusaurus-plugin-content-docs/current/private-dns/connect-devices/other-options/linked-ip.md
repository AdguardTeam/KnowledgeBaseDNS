...
1. Primero, debes comprobar si el DDNS es compatible con la configuración de tu router:
   ...
   - Navega hasta él y verifica que la configuración es realmente compatible. _Este es solo un ejemplo de cómo podría verse. It may vary depending on your router_
