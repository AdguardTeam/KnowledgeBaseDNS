...
9. All done! Your device is successfully connected to AdGuard DNS. Haz clic en _Activar_ cada vez que quieras iniciar la protección.
...
4. Toca _Guardar_.
   ...
   ¡Listo! Your device is successfully connected to AdGuard DNS.
