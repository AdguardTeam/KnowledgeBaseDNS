...
Hurricane Electric Public Recursor, Hurricane Electric'in her noktaya yayın özelliğine sahip ücretsiz bir alternatif DNS hizmetidir.
...
[Xstl DNS](https://get.dns.seia.io/) is a public DNS service based in South Korea that doesn't log the user's IP. Reklamlar ve izleyiciler engellenir.
...
We won't be able to proper monitor their availability. **Bunları kendi sorumluluğunuzda kullanın.**
...
[NWPS.fi DNS](https://nwps.fi), DoH ve DoT çözümleyicilerine iki filtreleme düzeyi sağlar.
