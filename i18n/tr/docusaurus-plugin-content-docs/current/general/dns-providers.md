...
[FutureDNS](https://futuredns.eu.org) is a privacy-focused DNS service that blocks ads, trackers, and malware. Hem standart DNS'i hem de şifrelenmiş protokolleri desteklerken, katı bir kayıt tutmama politikasını sürdürür.
