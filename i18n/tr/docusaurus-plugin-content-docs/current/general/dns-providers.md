...
[Caliph DNS](https://dns.caliph.dev) is a free DNS service based in Indonesia. Note: The website (https://dns.caliph.dev) is currently returning HTTP 502. DNS hizmetinin kendisi (DoH/DoT/DNS IPv4) çalışmaya devam eder. This service applies SafeSearch enforcement on Google queries and blocks certain websites (e.g., Reddit returns `internetpositif.id`).
...
| DNS-over-TLS   | `tls://dns.caliph.dev:853`         | [AdGuard'a ekle](adguard:add_dns_server?address=tls://dns.caliph.dev:853&name=dns.caliph.dev:853), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=tls://dns.caliph.dev:853&name=dns.caliph.dev:853)         |
...
| Protokol       | Adres                                                          |                                                                                                                                                                                                                         |
| -------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `208.67.222.222` ve `208.67.220.220`                           | [Add to AdGuard](adguard:add_dns_server?address=208.67.222.222&name=Cisco%20OpenDNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=208.67.222.222&name=Cisco%20OpenDNS)                                       |
| DNS, IPv6      | `2620:119:35::35` ve `2620:119:53::53`                         | [Add to AdGuard](adguard:add_dns_server?address=2620:119:35::35&name=Cisco%20OpenDNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2620:119:35::35&name=Cisco%20OpenDNS)                                     |
...
| Protokol       | Adres                                                         |                                                                                                                                                                                                                                                                             |
| -------------- | ------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `208.67.222.123` ve `208.67.220.123`                          | [Add to AdGuard](adguard:add_dns_server?address=208.67.222.123&name=Cisco%20OpenDNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=208.67.222.123&name=Cisco%20OpenDNS)                                                                                           |
...
| Protokol       | Adres                                       |                                                                                                                                                                                                                                                         |
| -------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `208.67.222.2` ve `208.67.220.2`            | [Add to AdGuard](adguard:add_dns_server?address=208.67.222.2&name=Cisco%20OpenDNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=208.67.222.2&name=Cisco%20OpenDNS)                                                                           |
...
| Protokol       | Adres                                                     |                                                                                                                                                                                                                                                                                 |
| -------------- | --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `185.228.168.168` ve `185.228.169.168`                    | [Add to AdGuard](adguard:add_dns_server?address=185.228.168.168&name=CleanBrowsing), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=185.228.168.168&name=CleanBrowsing)                                                                                                 |
| DNS, IPv6      | `2a0d:2a00:1::` ve `2a0d:2a00:2::`                        | [Add to AdGuard](adguard:add_dns_server?address=2a0d:2a00:1::&name=CleanBrowsing), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2a0d:2a00:1::&name=CleanBrowsing)                                                                                                     |
...
| Protokol       | Adres                                                      |                                                                                                                                                                                                                                                                             |
| -------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `185.228.168.10` ve `185.228.169.11`                       | [Add to AdGuard](adguard:add_dns_server?address=185.228.168.10&name=CleanBrowsing), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=185.228.168.10&name=CleanBrowsing)                                                                                               |
| DNS, IPv6      | `2a0d:2a00:1::1` ve `2a0d:2a00:2::1`                       | [Add to AdGuard](adguard:add_dns_server?address=2a0d:2a00:1::1&name=CleanBrowsing), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2a0d:2a00:1::1&name=CleanBrowsing)                                                                                               |
...
| Protokol       | Adres                                                |                                                                                                                                                                                                                                                                                         |
| -------------- | ---------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `185.228.168.9` ve `185.228.169.9`                   | [Add to AdGuard](adguard:add_dns_server?address=185.228.168.9&name=CleanBrowsing), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=185.228.168.9&name=CleanBrowsing)                                                                                                             |
| DNS, IPv6      | `2a0d:2a00:1::2` ve `2a0d:2a00:2::2`                 | [Add to AdGuard](adguard:add_dns_server?address=2a0d:2a00:1::2&name=CleanBrowsing), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2a0d:2a00:1::2&name=CleanBrowsing)                                                                                                           |
...
| Protokol             | Adres                                            |                                                                                                                                                                                                                                           |
| -------------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4            | `1.1.1.1` ve `1.0.0.1`                           | [Add to AdGuard](adguard:add_dns_server?address=1.1.1.1&name=Cloudflare%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=1.1.1.1&name=Cloudflare%20DNS)                                                                     |
| DNS, IPv6            | `2606:4700:4700::1111` ve `2606:4700:4700::1001` | [Add to AdGuard](adguard:add_dns_server?address=2606:4700:4700::1111&name=Cloudflare%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2606:4700:4700::1111&name=Cloudflare%20DNS)                                           |
...
| DNS-over-HTTPS, IPv6 | `https://cloudflare-dns.com/dns-query`           | [AdGuard'a ekle](adguard:add_dns_server?address=https://dns.cloudflare.com:53/dns-query&name=dns.cloudflare.com), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=https://dns.cloudflare.com:53/dns-query&name=dns.cloudflare.com) |
...
| Protokol       | Adres                                            |                                                                                                                                                                                                                                                                         |
| -------------- | ------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `1.1.1.2` ve `1.0.0.2`                           | [Add to AdGuard](adguard:add_dns_server?address=1.1.1.2&name=Cloudflare%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=1.1.1.2&name=Cloudflare%20DNS)                                                                                                   |
| DNS, IPv6      | `2606:4700:4700::1112` ve `2606:4700:4700::1002` | [Add to AdGuard](adguard:add_dns_server?address=2606:4700:4700::1112&name=Cloudflare%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2606:4700:4700::1112&name=Cloudflare%20DNS)                                                                         |
...
| Protokol             | Adres                                            |                                                                                                                                                                                                                                                                 |
| -------------------- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4            | `1.1.1.3` ve `1.0.0.3`                           | [Add to AdGuard](adguard:add_dns_server?address=1.1.1.3&name=Cloudflare%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=1.1.1.3&name=Cloudflare%20DNS)                                                                                           |
| DNS, IPv6            | `2606:4700:4700::1113` ve `2606:4700:4700::1003` | [Add to AdGuard](adguard:add_dns_server?address=2606:4700:4700::1113&name=Cloudflare%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2606:4700:4700::1113&name=Cloudflare%20DNS)                                                                 |
...
| Protokol       | Adres                                                                  |                                                                                                                                                                                       |
| -------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `8.26.56.26` ve `8.20.247.20`                                          | [Add to AdGuard](adguard:add_dns_server?address=8.26.56.26&name=Comodo%20Secure%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=8.26.56.26&name=Comodo%20Secure%20DNS) |
...
| DNS, IPv6      | `2606:1a40::` ve `2606:1a40:1::`  | [Add to AdGuard](adguard:add_dns_server?address=2606:1a40::&name=ControlD), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2606:1a40::&name=ControlD)                                         |
...
| Protokol     | Adres                                                                                                                               |                                                                                                                                                                                                                                 |
| ------------ | ----------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-TLS | Ana makine adı: `tls://getdnsapi.net` IP: `185.49.141.37` ve IPv6: `2a04:b900:0:100::37`                                            | [AdGuard'a ekle](adguard:add_dns_server?address=tls://getdnsapi.net&name=getdnsapi.net), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=tls://getdnsapi.net&name=getdnsapi.net)                                         |
...
| DNS-over-TLS       | Provider: `Go6Lab` Hostname: `tls://privacydns.go6lab.si` and IPv6: `2001:67c:27e4::35`                                    | [AdGuard'a ekle](adguard:add_dns_server?address=tls://privacydns.go6lab.si&name=privacydns.go6lab.si), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=tls://privacydns.go6lab.si&name=privacydns.go6lab.si)                 |
| DNS-over-TLS       | Ana makine adı: `tls://dot.securedns.eu` IP: `146.185.167.43` ve IPv6: `2a03:b0c0:0:1010::e9a:3001`                        | [AdGuard'a ekle](adguard:add_dns_server?address=tls://dot.securedns.eu&name=dot.securedns.eu), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=tls://dot.securedns.eu&name=dot.securedns.eu)                                 |
...
| Protokol       | Adres                              |                                                                                                                                                                                                     |
| -------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `185.222.222.222` ve `45.11.45.11` | [Add to AdGuard](adguard:add_dns_server?address=185.222.222.222&name=DNS.SB), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=185.222.222.222&name=DNS.SB)                                   |
| DNS, IPv6      | `2a09::` ve `2a11::`               | [Add to AdGuard](adguard:add_dns_server?address=2a09::&name=DNS.SB), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2a09::&name=DNS.SB)                                                     |
...
| Protokol  | Adres                             |                                                                                                                                                                       |
| --------- | --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `54.174.40.213` ve `52.3.100.184` | [Add to AdGuard](adguard:add_dns_server?address=54.174.40.213&name=DNSWatchGO), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=54.174.40.213&name=DNSWatchGO) |
...
| Protokol  | Adres                              |                                                                                                                                                                     |
| --------- | ---------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `216.146.35.35` ve `216.146.36.36` | [Add to AdGuard](adguard:add_dns_server?address=216.146.35.35&name=Dyn%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=216.146.35.35&name=Dyn%20DNS) |
...
| Protokol  | Adres                          |                                                                                                                                                                             |
| --------- | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `80.80.80.80` ve `80.80.81.81` | [Add to AdGuard](adguard:add_dns_server?address=80.80.80.80&name=Freenom%20World), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=80.80.80.80&name=Freenom%20World) |
...
| Protokol       | Adres                                            |                                                                                                                                                                                                     |
| -------------- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `8.8.8.8` ve `8.8.4.4`                           | [Add to AdGuard](adguard:add_dns_server?address=8.8.8.8&name=Google%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=8.8.8.8&name=Google%20DNS)                                       |
| DNS, IPv6      | `2001:4860:4860::8888` ve `2001:4860:4860::8844` | [Add to AdGuard](adguard:add_dns_server?address=2001:4860:4860::8888&name=Google%20DNS), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2001:4860:4860::8888&name=Google%20DNS)             |
...
| Protokol       | Adres                                                        |                                                                                                                                                                   |
| -------------- | ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `180.131.144.144` ve `180.131.145.145`                       | [Add to AdGuard](adguard:add_dns_server?address=180.131.144.144&name=Nawala), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=180.131.144.144&name=Nawala) |
...
| Protokol  | Adres                                  |                                                                                                                                                                     |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `156.154.70.1` ve `156.154.71.1`       | [Add to AdGuard](adguard:add_dns_server?address=156.154.70.1&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=156.154.70.1&name=Neustar)       |
| DNS, IPv6 | `2610:a1:1018::1` ve `2610:a1:1019::1` | [Add to AdGuard](adguard:add_dns_server?address=2610:a1:1018::1&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2610:a1:1018::1&name=Neustar) |
...
| Protokol  | Adres                                  |                                                                                                                                                                     |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `156.154.70.5` ve `156.154.71.5`       | [Add to AdGuard](adguard:add_dns_server?address=156.154.70.5&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=156.154.70.5&name=Neustar)       |
| DNS, IPv6 | `2610:a1:1018::5` ve `2610:a1:1019::5` | [Add to AdGuard](adguard:add_dns_server?address=2610:a1:1018::5&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2610:a1:1018::5&name=Neustar) |
...
| Protokol  | Adres                                  |                                                                                                                                                                     |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `156.154.70.2` ve `156.154.71.2`       | [Add to AdGuard](adguard:add_dns_server?address=156.154.70.2&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=156.154.70.2&name=Neustar)       |
| DNS, IPv6 | `2610:a1:1018::2` ve `2610:a1:1019::2` | [Add to AdGuard](adguard:add_dns_server?address=2610:a1:1018::2&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2610:a1:1018::2&name=Neustar) |
...
| Protokol  | Adres                                  |                                                                                                                                                                     |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `156.154.70.3` ve `156.154.71.3`       | [Add to AdGuard](adguard:add_dns_server?address=156.154.70.3&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=156.154.70.3&name=Neustar)       |
| DNS, IPv6 | `2610:a1:1018::3` ve `2610:a1:1019::3` | [Add to AdGuard](adguard:add_dns_server?address=2610:a1:1018::3&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2610:a1:1018::3&name=Neustar) |
...
| Protokol  | Adres                                  |                                                                                                                                                                     |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `156.154.70.4` ve `156.154.71.4`       | [Add to AdGuard](adguard:add_dns_server?address=156.154.70.4&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=156.154.70.4&name=Neustar)       |
| DNS, IPv6 | `2610:a1:1018::4` ve `2610:a1:1019::4` | [Add to AdGuard](adguard:add_dns_server?address=2610:a1:1018::4&name=Neustar), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2610:a1:1018::4&name=Neustar) |
...
| Protokol       | Adres                                                           |                                                                                                                                                                                                                 |
| -------------- | --------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `9.9.9.9` ve `149.112.112.112`                                  | [Add to AdGuard](adguard:add_dns_server?address=9.9.9.9&name=Quad9), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=9.9.9.9&name=Quad9)                                                                 |
| DNS, IPv6      | `2620:fe::fe` IP: `2620:fe::fe:9`                               | [Add to AdGuard](adguard:add_dns_server?address=2620:fe::fe&name=Quad9), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2620:fe::fe&name=Quad9)                                                         |
...
| Protokol       | Adres                                                              |                                                                                                                                                                                                                         |
| -------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `9.9.9.10` ve `149.112.112.10`                                     | [Add to AdGuard](adguard:add_dns_server?address=9.9.9.10&name=Quad9), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=149.112.112.10&name=Quad9)                                                                 |
...
EDNS İstemci Alt Ağı, yetkili DNS sunucularına gönderilen isteklerde son kullanıcı IP adresi verilerinin bileşenlerini içeren bir yöntemdir. It provides security blocklist, DNSSEC, EDNS Client Subnet.

| Protokol       | Adres                                                           |                                                                                                                                                                                                                         |
| -------------- | --------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `9.9.9.11` ve `149.112.112.11`                                  | [Add to AdGuard](adguard:add_dns_server?address=9.9.9.11&name=Quad9), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=9.9.9.11&name=Quad9)                                                                       |
...
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.safesurfer.co.nz` IP: `104.197.28.121` | [AdGuard'a ekle](sdns://AQMAAAAAAAAADjEwNC4xOTcuMjguMTIxICcgf9USBOg2e0g0AF35_9HTC74qnDNjnm7b-K7ZHUDYIDIuZG5zY3J5cHQtY2VydC5zYWZlc3VyZmVyLmNvLm56)                               |
...
| DNS, IPv6      | `2a09:a707:169::`                        | [AdGuard'a ekle](adguard:add_dns_server?address=2a09:a707:169::&name=Surfshark%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a09:a707:169::&name=Surfshark%20DNS)                                                         |
...
| DNS, IPv6 | `2620:74:1b::1:1` and `2620:74:1c::2:2` | [AdGuard'a ekle](adguard:add_dns_server?address=2620:74:1b::1:1&name=Verisign), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2620:74:1b::1:1&name=Verisign) |
...
| Protokol  | Adres                           |                                                                                                                                                                 |
| --------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `180.184.1.1` and `180.184.2.2` | [AdGuard'a ekle](adguard:add_dns_server?address=180.184.1.1&name=ByteDance), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=180.184.1.1&name=ByteDance) |
...
| DNS, IPv6              | `2620:10A:80BB::10` and `2620:10A:80BC::10`                                                         | [AdGuard'a ekle](adguard:add_dns_server?address=2620:10A:80BB::10&name=CIRA%20Canadian%20Shield), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2620:10A:80BB::10&name=CIRA%20Canadian%20Shield)                                                                           |
...
| Protokol                 | Adres                                                                                                 |                                                                                                                                                                                                                                                                                             |
| ------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4                | `149.112.121.20` and `149.112.122.20`                                                                 | [AdGuard'a ekle](adguard:add_dns_server?address=149.112.121.20&name=CIRA%20Canadian%20Shield), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=149.112.121.20&name=CIRA%20Canadian%20Shield)                                                                                         |
| DNS, IPv6                | `2620:10A:80BB::20` and `2620:10A:80BC::20`                                                           | [AdGuard'a ekle](adguard:add_dns_server?address=2620:10A:80BB::20&name=CIRA%20Canadian%20Shield), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2620:10A:80BB::20&name=CIRA%20Canadian%20Shield)                                                                                   |
...
#### Reklam filtreleme ile coğrafi engelleme atlama
...
[CZ.NIC ODVR](https://www.nic.cz/odvr/) CZ.NIC ODVR, Açık DNSSEC Doğrulama Çözümleyicisidir. CZ.NIC neither collect any personal data nor gather information on pages where devices sends personal data.

| Protokol       | Adres                                       |                                                                                                                                                                                             |
| -------------- | ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `193.17.47.1` and `185.43.135.1`            | [AdGuard'a ekle](adguard:add_dns_server?address=193.17.47.1&name=CZ.NIC%20ODVR), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=193.17.47.1&name=CZ.NIC%20ODVR)                     |
| DNS, IPv6      | `2001:148f:ffff::1` and `2001:148f:fffe::1` | [AdGuard'a ekle](adguard:add_dns_server?address=2001:148f:ffff::1&name=CZ.NIC%20ODVR), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2001:148f:ffff::1&name=CZ.NIC%20ODVR)         |
...
| DNS, IPv4      | `94.130.180.225` and `78.47.64.161`                        | [AdGuard'a ekle](adguard:add_dns_server?address=94.130.180.225&name=DNS%20for%20Family), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=94.130.180.225&name=DNS%20for%20Family)                                                                     |
| DNS, IPv6      | `2a01:4f8:1c0c:40db::1` and `2a01:4f8:1c17:4df8::1`        | [AdGuard'a ekle](adguard:add_dns_server?address=2a01:4f8:1c0c:40db::1&name=DNS%20for%20Family), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a01:4f8:1c0c:40db::1&name=DNS%20for%20Family)                                                       |
...
| Protokol       | Adres                                                 |                                                                                                                                                                                                                     |
| -------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `86.54.11.1` and `86.54.11.201`                       | [AdGuard'a ekle](adguard:add_dns_server?address=86.54.11.1&name=DNS4EU), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=86.54.11.1&name=DNS4EU)                                                             |
| DNS, IPv6      | `2a13:1001::86:54:11:1` and `2a13:1001::86:54:11:201` | [AdGuard'a ekle](adguard:add_dns_server?address=2a13:1001::86:54:11:1&name=DNS4EU), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:1&name=DNS4EU)                                       |
| DNS-over-HTTPS | `https://protective.joindns4.eu/dns-query`            | [AdGuard'a ekle](adguard:add_dns_server?address=https://protective.joindns4.eu/dns-query&name=DNS4EU), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=https://protective.joindns4.eu/dns-query&name=DNS4EU) |
...
| DNS, IPv6      | `2a13:1001::86:54:11:12` and `2a13:1001::86:54:11:212` | [AdGuard'a ekle](adguard:add_dns_server?address=2a13:1001::86:54:11:12&name=DNS4EU), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:12&name=DNS4EU)                           |
...
| DNS-over-TLS   | `tls://noads.joindns4.eu`                              | [AdGuard'a ekle](adguard:add_dns_server?address=tls://noads.joindns4.eu&name=DNS4EU), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=tls://noads.joindns4.eu&name=DNS4EU)                         |
...
| DNS, IPv6      | `2400:7fc0:849e:200::8` and `2404:c2c0:85d8:901::8` | [AdGuard'a ekle](adguard:add_dns_server?address=2400:7fc0:849e:200::8&name=OneDNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2400:7fc0:849e:200::8&name=OneDNS)                                                           |
...
| DNS, IPv6      | `2400:7fc0:849e:200::4` and `2404:c2c0:85d8:901::4` | [AdGuard'a ekle](adguard:add_dns_server?address=2400:7fc0:849e:200::4&name=OneDNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2400:7fc0:849e:200::4&name=OneDNS)                                       |
...
| Protokol  | Adres                   |                                                                                                                                                                                 |
| --------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `217.160.70.42`         | [AdGuard'a ekle](adguard:add_dns_server?address=217.160.70.42&name=OpenNIC), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=217.160.70.42&name=OpenNIC)                 |
| DNS, IPv6 | `2001:8d8:1801:86e7::1` | [AdGuard'a ekle](adguard:add_dns_server?address=2001:8d8:1801:86e7::1&name=OpenNIC), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2001:8d8:1801:86e7::1&name=OpenNIC) |
...
| Protokol     | Adres                                   |                                                                                                                                                                                                 |
| ------------ | --------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4    | `101.101.101.101` and `101.102.103.104` | [AdGuard'a ekle](adguard:add_dns_server?address=101.101.101.101&name=Quad101), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=101.101.101.101&name=Quad101)                             |
| DNS, IPv6    | `2001:de4::101` and `2001:de4::102`     | [AdGuard'a ekle](adguard:add_dns_server?address=2001:de4::101&name=Quad101), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2001:de4::101&name=Quad101)                                 |
...
| Protokol       | Adres                                 |                                                                                                                                                                                                                                 |
| -------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `5.2.75.75`                           | [AdGuard'a ekle](adguard:add_dns_server?address=5.2.75.75&name=AhaDNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=5.2.75.75&name=AhaDNS)                                                                           |
| DNS, IPv6      | `2a04:52c0:101:75::75`                | [AdGuard'a ekle](adguard:add_dns_server?address=2a04:52c0:101:75::75&name=AhaDNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a04:52c0:101:75::75&name=AhaDNS)                                                     |
...
| Protokol       | Adres                                 |                                                                                                                                                                                                                                 |
| -------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `45.67.219.208`                       | [AdGuard'a ekle](adguard:add_dns_server?address=45.67.219.208&name=AhaDNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=45.67.219.208&name=AhaDNS)                                                                   |
| DNS, IPv6      | `2a04:bdc7:100:70::70`                | [AdGuard'a ekle](adguard:add_dns_server?address=2a04:bdc7:100:70::70&name=AhaDNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a04:bdc7:100:70::70&name=AhaDNS)                                                     |
...
| Protokol       | Adres                                                            |                                                                                                                                                  |
| -------------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.captnemo.in` IP: `139.59.48.222:4434` | [AdGuard'a ekle](sdns://AQQAAAAAAAAAEjEzOS41OS40OC4yMjI6NDQzNCAFOt_yxaMpFtga2IpneSwwK6rV0oAyleham9IvhoceEBsyLmRuc2NyeXB0LWNlcnQuY2FwdG5lbW8uaW4) |
...
| Protokol       | Adres                                                 |                                                                                                                                                                                                         |
| -------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `176.9.93.198` and `176.9.1.117`                      | [AdGuard'a ekle](adguard:add_dns_server?address=176.9.93.198&name=DNS%20Forge), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=176.9.93.198&name=DNS%20Forge)                                   |
| DNS, IPv6      | `2a01:4f8:151:34aa::198` and `2a01:4f8:141:316d::117` | [AdGuard'a ekle](adguard:add_dns_server?address=2a01:4f8:151:34aa::198&name=DNS%20Forge), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2a01:4f8:151:34aa::198&name=DNS%20Forge)               |
...
| Protokol       | Adres                                  |                                                                                                                                                                                                             |
| -------------- | -------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `62.192.153.242` ve `62.192.153.243`   | [Add to AdGuard](adguard:add_dns_server?address=62.192.153.242&name=DNSGUARD), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=62.192.153.242&name=DNSGUARD)                                         |
| DNS, IPv6      | `2a0c:4ac1:29::2` ve `2a0c:4ac1:29::3` | [Add to AdGuard](adguard:add_dns_server?address=2a0c:4ac1:29::2&name=DNSGUARD), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=2a0c:4ac1:29::2&name=DNSGUARD)                                       |
...
| DNSCrypt, IPv4  | Provider: `2.dnscrypt-cert.ffmuc.net` IP: `5.1.66.255:8443`            | [AdGuard'a ekle](sdns://AQcAAAAAAAAADzUuMS42Ni4yNTU6ODQ0MyAH0Hrxz9xdmXadPwJmkKcESWXCdCdseRyu9a7zuQxG-hkyLmRuc2NyeXB0LWNlcnQuZmZtdWMubmV0)                                                                       |
| DNSCrypt, IPv6  | Provider: `2.dnscrypt-cert.ffmuc.net` IP: `[2001:678:e68:f000::]:8443` | [AdGuard'a ekle](sdns://AQcAAAAAAAAAGlsyMDAxOjY3ODplNjg6ZjAwMDo6XTo4NDQzIAfQevHP3F2Zdp0_AmaQpwRJZcJ0J2x5HK71rvO5DEb6GTIuZG5zY3J5cHQtY2VydC5mZm11Yy5uZXQ)                                                        |
...
| Protokol       | Adres                                                                |                                                                                                                                                       |
| -------------- | -------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.dnsrec.meo.ws` IP: `185.121.177.177:5353` | [AdGuard'a ekle](sdns://AQYAAAAAAAAAFDE4NS4xMjEuMTc3LjE3Nzo1MzUzIBpq0KMrTFphppXRU2cNaasWkD-ew_f2TxPlNaMYsiilHTIuZG5zY3J5cHQtY2VydC5kbnNyZWMubWVvLndz) |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.dnsrec.meo.ws` IP: `169.239.202.202:5353` | [AdGuard'a ekle](sdns://AQYAAAAAAAAAFDE2OS4yMzkuMjAyLjIwMjo1MzUzIBpq0KMrTFphppXRU2cNaasWkD-ew_f2TxPlNaMYsiilHTIuZG5zY3J5cHQtY2VydC5kbnNyZWMubWVvLndz) |
...
| DNSCrypt, IPv4       | Provider: `2.dnscrypt-cert.ibksturm` IP: `213.196.191.96:8443`          | [AdGuard'a ekle](sdns://AQcAAAAAAAAAEzIxMy4xOTYuMTkxLjk2Ojg0NDMgK374BJKvK0aJHWKjmXdkG8_X2KEoao_LALK_nK6PM_AYMi5kbnNjcnlwdC1jZXJ0Lmlia3N0dXJt)                                                                                               |
...
| Protokol       | Adres                                                                    |                                                                                                                                                                                                         |
| -------------- | ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `51.38.83.141`                                                           | [AdGuard'a ekle](adguard:add_dns_server?address=51.38.83.141&name=OSZX%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=51.38.83.141&name=OSZX%20DNS)                                     |
| DNS, IPv6      | `2001:41d0:801:2000::d64`                                                | [AdGuard'a ekle](adguard:add_dns_server?address=2001:41d0:801:2000::d64&name=OSZX%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2001:41d0:801:2000::d64&name=OSZX%20DNS)               |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.oszx.co` IP: `51.38.83.141:5353`              | [AdGuard'a ekle](sdns://AQIAAAAAAAAAETUxLjM4LjgzLjE0MTo1MzUzIMwm9_oYw26P4JIVoDhJ_5kFDdNxX1ke4fEzL1V5bwEjFzIuZG5zY3J5cHQtY2VydC5vc3p4LmNv)                                                               |
| DNSCrypt, IPv6 | Provider: `2.dnscrypt-cert.oszx.co` IP: `[2001:41d0:801:2000::d64]:5353` | [AdGuard'a ekle](sdns://AQIAAAAAAAAAHDIwMDE6NDFkMDo4MDE6MjAwMDo6ZDY0OjUzNTMgzCb3-hjDbo_gkhWgOEn_mQUN03FfWR7h8TMvVXlvASMXMi5kbnNjcnlwdC1jZXJ0Lm9zenguY28)                                                |
...
| Protokol       | Adres                                                                         |                                                                                                                                                                                                                         |
| -------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `51.38.82.198`                                                                | [AdGuard'a ekle](adguard:add_dns_server?address=51.38.82.198&name=PumpleX), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=51.38.82.198&name=PumpleX)                                                           |
| DNS, IPv6      | `2001:41d0:801:2000::1b28`                                                    | [AdGuard'a ekle](adguard:add_dns_server?address=2001:41d0:801:2000::1b28&name=PumpleX), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2001:41d0:801:2000::1b28&name=PumpleX)                                   |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.pumplex.com` IP: `51.38.82.198:5353`               | [AdGuard'a ekle](sdns://AQcAAAAAAAAAETUxLjM4LjgyLjE5ODo1MzUzIMg95SNgpDPLmaHlbZVbYh5tJRvnYuDWqZ4lUG-mD49eGzIuZG5zY3J5cHQtY2VydC5wdW1wbGV4LmNvbQ)                                                                         |
| DNSCrypt, IPv6 | Provider: `2.dnscrypt-cert.pumplex.com` IP: `[2001:41d0:801:2000::1b28]:5353` | [AdGuard'a ekle](sdns://AQcAAAAAAAAAHTIwMDE6NDFkMDo4MDE6MjAwMDo6MWIyODo1MzUzIMg95SNgpDPLmaHlbZVbYh5tJRvnYuDWqZ4lUG-mD49eGzIuZG5zY3J5cHQtY2VydC5wdW1wbGV4LmNvbQ)                                                         |
...
| Protokol       | Adres                                                                      |                                                                                                                                                                                                                     |
| -------------- | -------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `174.138.21.128`                                                           | [AdGuard'a ekle](adguard:add_dns_server?address=174.138.21.128&name=Privacy-First%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=174.138.21.128&name=Privacy-First%20DNS)                           |
| DNS, IPv6      | `2400:6180:0:d0::5f6e:4001`                                                | [AdGuard'a ekle](adguard:add_dns_server?address=2400:6180:0:d0::5f6e:4001&name=Privacy-First%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2400:6180:0:d0::5f6e:4001&name=Privacy-First%20DNS)     |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.dns.tiar.app` IP: `174.138.21.128`              | [AdGuard'a ekle](sdns://AQMAAAAAAAAADjE3NC4xMzguMjEuMTI4IO-WgGbo2ZTwZdg-3dMa7u31bYZXRj5KykfN1_6Xw9T2HDIuZG5zY3J5cHQtY2VydC5kbnMudGlhci5hcHA)                                                                        |
| DNSCrypt, IPv6 | Provider: `2.dnscrypt-cert.dns.tiar.app` IP: `[2400:6180:0:d0::5f6e:4001]` | [AdGuard'a ekle](sdns://AQMAAAAAAAAAG1syNDAwOjYxODA6MDpkMDo6NWY2ZTo0MDAxXSDvloBm6NmU8GXYPt3TGu7t9W2GV0Y-SspHzdf-l8PU9hwyLmRuc2NyeXB0LWNlcnQuZG5zLnRpYXIuYXBw)                                                       |
...
| Protokol       | Adres                                                                          |                                                                                                                                                                                                                           |
| -------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `172.104.93.80`                                                                | [AdGuard'a ekle](adguard:add_dns_server?address=172.104.93.80&name=Privacy-First%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=172.104.93.80&name=Privacy-First%20DNS)                                   |
| DNS, IPv6      | `2400:8902::f03c:91ff:feda:c514`                                               | [AdGuard'a ekle](adguard:add_dns_server?address=2400:8902::f03c:91ff:feda:c514&name=Privacy-First%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=2400:8902::f03c:91ff:feda:c514&name=Privacy-First%20DNS) |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.jp.tiar.app` IP: `172.104.93.80`                    | [AdGuard'a ekle](sdns://AQcAAAAAAAAAEjE3Mi4xMDQuOTMuODA6MTQ0MyAyuHY-8b9lNqHeahPAzW9IoXnjiLaZpTeNbVs8TN9UUxsyLmRuc2NyeXB0LWNlcnQuanAudGlhci5hcHA)                                                                          |
| DNSCrypt, IPv6 | Provider: `2.dnscrypt-cert.jp.tiar.app` IP: `[2400:8902::f03c:91ff:feda:c514]` | [AdGuard'a ekle](sdns://AQcAAAAAAAAAJVsyNDAwOjg5MDI6OmYwM2M6OTFmZjpmZWRhOmM1MTRdOjE0NDMgMrh2PvG_ZTah3moTwM1vSKF544i2maU3jW1bPEzfVFMbMi5kbnNjcnlwdC1jZXJ0LmpwLnRpYXIuYXBw)                                                 |
...
| Protokol       | Adres                                                      |                                                                                                                                                                                             |
| -------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `45.76.113.31`                                             | [AdGuard'a ekle](adguard:add_dns_server?address=45.76.113.31&name=Seby%20DNS), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=45.76.113.31&name=Seby%20DNS)                         |
| DNSCrypt, IPv4 | Provider: `2.dnscrypt-cert.dns.seby.io` IP: `45.76.113.31` | [AdGuard'a ekle](sdns://AQcAAAAAAAAADDQ1Ljc2LjExMy4zMSAIVGh4i6eKXqlF6o9Fg92cgD2WcDvKQJ7v_Wq4XrQsVhsyLmRuc2NyeXB0LWNlcnQuZG5zLnNlYnkuaW8)                                                    |
