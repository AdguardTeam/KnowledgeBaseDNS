...
| Protokol        | Adres                                                                   |                                                                                                                                                                                                                 |
| --------------- | ----------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-TLS    | Ana makine adı: `tls://dot.ffmuc.net`                                   | [AdGuard'a ekle](adguard:add_dns_server?address=tls://dot.ffmuc.net&name=dot.ffmuc.net), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=tls://dot.ffmuc.net&name=dot.ffmuc.net)                         |
| DNS-over-HTTPS  | Ana makine adı: `https://doh.ffmuc.net/dns-query`                       | [AdGuard'a ekle](adguard:add_dns_server?address=https://doh.ffmuc.net/dns-query&name=doh.ffmuc.net), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=https://doh.ffmuc.net/dns-query&name=doh.ffmuc.net) |
| DNS-over-HTTP/3 | Ana makine adı: `h3://doh.ffmuc.net/dns-query`                          | [AdGuard'a ekle](adguard:add_dns_server?address=h3://doh.ffmuc.net/dns-query&name=doh.ffmuc.net), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=h3://doh.ffmuc.net/dns-query&name=doh.ffmuc.net)       |
| DNS-over-QUIC   | Ana makine adı: `quic://doq.ffmuc.net`                                  | [AdGuard'a ekle](adguard:add_dns_server?address=quic://doq.ffmuc.net&name=doq.ffmuc.net), [AdGuard VPN'e ekle](adguardvpn:add_dns_server?address=quic://doq.ffmuc.net&name=doq.ffmuc.net)                       |
...
| DNSCrypt, IPv4       | Sağlayıcı: `2.dnscrypt-cert.ibksturm` IP: `213.196.191.96:8443`               | [AdGuard'a ekle](sdns://AQcAAAAAAAAAEzIxMy4xOTYuMTkxLjk2Ojg0NDMgK374BJKvK0aJHWKjmXdkG8_X2KEoao_LALK_nK6PM_AYMi5kbnNjcnlwdC1jZXJ0Lmlia3N0dXJt)                                                                                               |
