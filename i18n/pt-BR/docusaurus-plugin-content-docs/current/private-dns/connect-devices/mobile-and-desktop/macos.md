...
8. Copy one of the following DNS addresses and paste it into the _DNS servers_ field in the app. Se você não tem certeza sobre qual optar, selecione _DNS-over-HTTPS_.
