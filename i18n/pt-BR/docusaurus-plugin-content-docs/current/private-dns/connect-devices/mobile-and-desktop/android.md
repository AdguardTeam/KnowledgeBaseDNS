...
1. [Baixe o aplicativo AdGuard DNS](https://agrd.io/android_dns).
...
5. Expanda a seção _Usar aplicativos do AdGuard_.
   ...
   ![Use AdGuard apps \*border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/UseAdGuardApps-pt_br.png)

6. Em _Usar o aplicativo DNS do AdGuard_, escolha um destes métodos de configuração:
   ...
   - Copie seu ID de configuração e cole-o diretamente no aplicativo.
     ...
     ![Setup ID \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/Setup-ID-pt.png)

7. Toque em _Continuar_ → _Conectar_.
