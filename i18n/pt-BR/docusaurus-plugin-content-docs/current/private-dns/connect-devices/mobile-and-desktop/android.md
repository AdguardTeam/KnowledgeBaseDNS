...
4. Toque em _Salvar_.
   ...
   All done! Seu dispositivo foi conectado com sucesso ao AdGuard DNS.

## Configure plain DNS

Se você preferir não usar software extra para configuração de DNS, pode optar por DNS não criptografado. You have two choices: using linked IPs or dedicated IPs.
