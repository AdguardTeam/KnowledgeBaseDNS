...
7. Copy one of the following DNS addresses and paste it into the _DNS server adresses_ field in the app. If you are not sure which one to use, select DNS-over-HTTPS.
