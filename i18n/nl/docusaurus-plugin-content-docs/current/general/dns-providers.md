...
| Protocol      | Address                           |                                                                           |
| ------------- | --------------------------------- | ------------------------------------------------------------------------- |
| DNS-via-HTTPS | `https://dns.comss.one/dns-query` | [Add to AdGuard](sdns://AgAAAAAAAAAAAAANZG5zLmNvbXNzLm9uZQovZG5zLXF1ZXJ5) |
| DNS-via-TLS   | `tls://dns.comss.one`             | [Add to AdGuard](sdns://AwAAAAAAAAAAAAANZG5zLmNvbXNzLm9uZQ)               |
| DNS-via-QUIC  | `quic://dns.comss.one:784`        | [Add to AdGuard](sdns://BAAAAAAAAAAAAAARZG5zLmNvbXNzLm9uZTo3ODQ)          |

#### East DNS Server (Siberia and Far East)

| Protocol      | Address                                |                                                                                  |
| ------------- | -------------------------------------- | -------------------------------------------------------------------------------- |
| DNS-via-HTTPS | `https://dns.east.comss.one/dns-query` | [Add to AdGuard](sdns://AgAAAAAAAAAAAAASZG5zLmVhc3QuY29tc3Mub25lCi9kbnMtcXVlcnk) |
| DNS-via-TLS   | `tls://dns.east.comss.one`             | [Add to AdGuard](sdns://AwAAAAAAAAAAAAASZG5zLmVhc3QuY29tc3Mub25l)                |
| DNS-via-QUIC  | `quic://dns.east.comss.one`            | [Add to AdGuard](sdns://BAAAAAAAAAAAAAAWZG5zLmVhc3QuY29tc3Mub25lOjc4NA)          |
...
| DNS-over-TLS - Private | Hostnaam: `tls://family.canadianshield.cira.ca` IP: `149.112.121.10` en IPv6: `2620:10A:80BB::10` | [Add to AdGuard](sdns://AwAAAAAAAAAAAAAecHJpdmF0ZS5jYW5hZGlhbnNoaWVsZC5jaXJhLmNh)                |
...
[DNS for Family](https://dnsforfamily.com/) aims to block adult websites. Het stelt kinderen en volwassenen in staat om veilig op internet te surfen zonder zich zorgen te maken dat ze worden gevolgd door kwaadaardige websites.
...
[FreeDNS](https://freedns.zone/) is een open, gratis en openbare DNS-service. No DNS redirects, no logging.
