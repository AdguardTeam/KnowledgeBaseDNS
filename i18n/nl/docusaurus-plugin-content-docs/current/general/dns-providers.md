...
[OpenBLD.net DNS](https://openbld.net/) - Anycast/GeoDNS DNS-over-HTTPS, DNS-over-TLS-resolvers met blokkering: reclame, volgers, adware, malware, kwaadaardige activiteiten en phishing-bedrijven, blokkeert ~1 miljoen domeinen. Has 24h/48h logs for DDoS/Flood attack mitigation.
