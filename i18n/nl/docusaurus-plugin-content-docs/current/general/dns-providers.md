...
### Caliph DNS
 ...
 | Soort          | Adres                              |                                                                                                                                                                                                                                   |
 | -------------- | ---------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
 | DNS, IPv4      | `160.19.167.150`                   | [Toevoegen aan AdGuard](adguard:add_dns_server?address=160.19.167.150&name=160.19.167.150), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=160.19.167.150&name=160.19.167.150)                                     |
 | DNS, IPv6      | `2001:df7:5300:3::51e`             | [Toevoegen aan AdGuard](adguard:add_dns_server?address=2001:df7:5300:3::51e&name=2001:df7:5300:3::51e), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=2001:df7:5300:3::51e&name=2001:df7:5300:3::51e)             |
...
| DNS-over-HTTPS, IPv6 | `https://dns.cloudflare.com/dns-query`            | [Toevoegen aan AdGuard](adguard:add_dns_server?address=https://dns.cloudflare.com:53/dns-query&name=dns.cloudflare.com), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=https://dns.cloudflare.com:53/dns-query&name=dns.cloudflare.com) |
...
#### Alleen malware blokkeren

| Protocol       | Adres                                             |                                                                                                                                                                                                                                                                                       |
| -------------- | ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `1.1.1.2` en `1.0.0.2`                            | [Add to AdGuard](adguard:add_dns_server?address=1.1.1.2&name=), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=1.1.1.2&name=)                                                                                                                                                 |
...
| DNS-over-HTTPS | `https://security.cloudflare-dns.com/dns-query`   | [Toevoegen aan AdGuard](adguard:add_dns_server?address=https://security.cloudflare-dns.com/dns-query&name=security.cloudflare-dns.com), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=https://security.cloudflare-dns.com/dns-query&name=security.cloudflare-dns.com) |
| DNS-over-TLS   | `tls://security.cloudflare-dns.com`               | [Toevoegen aan AdGuard](adguard:add_dns_server?address=tls://security.cloudflare-dns.com&name=security.cloudflare-dns.com), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=tls://security.cloudflare-dns.com&name=security.cloudflare-dns.com)                         |

#### Blokkeren van malware en inhoud voor volwassenen

| Protocol             | Adres                                             |                                                                                                                                                                                                                                                                 |
| -------------------- | ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4            | `1.1.1.3` en `1.0.0.3`                            | [Add to AdGuard](adguard:add_dns_server?address=1.1.1.3&name=), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=1.1.1.3&name=)                                                                                                                           |
...
| DNS-over-HTTP/3 | Hostnaam: `h3://doh.ffmuc.net/dns-query`                               | [Toevoegen aan AdGuard](adguard:add_dns_server?address=h3://doh.ffmuc.net/dns-query&name=doh.ffmuc.net), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=h3://doh.ffmuc.net/dns-query&name=doh.ffmuc.net) |
| DNS-over-QUIC   | Hostnaam: `quic://doq.ffmuc.net`                                       | [Toevoegen aan AdGuard](adguard:add_dns_server?address=quic://doq.ffmuc.net&name=doq.ffmuc.net), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=quic://doq.ffmuc.net&name=doq.ffmuc.net)                 |
...
[HaGeZi DNS](https://github.com/hagezi/dns-servers) is een gratis publieke DNS-service die DNS-niveau filtering biedt van advertenties, volgers, phishing, oplichterij en kwaadaardige domeinen, met een sterke focus op privacy en beveiliging. Alle servers bevinden zich uitsluitend binnen de EU en functioneren in overeenstemming met de GDPR-vereisten en de aanbevelingen van ENISA.

De service ondersteunt alleen versleutelde DNS-protocollen en registreert geen individuele DNS-queries.

#### Duitsland, Falkenstein

| Protocol       | Adres                               |                                                                                                                                                                                                                                       |
| -------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://root.hagezi.org/dns-query` | [Toevoegen aan AdGuard](adguard:add_dns_server?address=https://root.hagezi.org/dns-query&name=root.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=https://root.hagezi.org/dns-query&name=root.hagezi.org) |
| DNS-over-TLS   | `tls://root.hagezi.org`             | [Toevoegen aan AdGuard](adguard:add_dns_server?address=tls://root.hagezi.org&name=root.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=tls://root.hagezi.org&name=root.hagezi.org)                         |
| DNS-over-QUIC  | `quic://root.hagezi.org`            | [Toevoegen aan AdGuard](adguard:add_dns_server?address=quic://root.hagezi.org&name=root.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=quic://root.hagezi.org&name=root.hagezi.org)                       |

#### Duitsland, Neurenberg

| Protocol       | Adres                                |                                                                                                                                                                                                                                           |
| -------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://wurzn.hagezi.org/dns-query` | [Toevoegen aan AdGuard](adguard:add_dns_server?address=https://wurzn.hagezi.org/dns-query&name=wurzn.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=https://wurzn.hagezi.org/dns-query&name=wurzn.hagezi.org) |
| DNS-over-TLS   | `tls://wurzn.hagezi.org`             | [Toevoegen aan AdGuard](adguard:add_dns_server?address=tls://wurzn.hagezi.org&name=wurzn.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=tls://wurzn.hagezi.org&name=wurzn.hagezi.org)                         |
| DNS-over-QUIC  | `quic://wurzn.hagezi.org`            | [Toevoegen aan AdGuard](adguard:add_dns_server?address=quic://wurzn.hagezi.org&name=wurzn.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=quic://wurzn.hagezi.org&name=wurzn.hagezi.org)                       |

#### Finland, Helsinki

| Protocol       | Adres                                |                                                                                                                                                                                                                                           |
| -------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://juuri.hagezi.org/dns-query` | [Toevoegen aan AdGuard](adguard:add_dns_server?address=https://juuri.hagezi.org/dns-query&name=juuri.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=https://juuri.hagezi.org/dns-query&name=juuri.hagezi.org) |
| DNS-over-TLS   | `tls://juuri.hagezi.org`             | [Toevoegen aan AdGuard](adguard:add_dns_server?address=tls://juuri.hagezi.org&name=juuri.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=tls://juuri.hagezi.org&name=juuri.hagezi.org)                         |
| DNS-over-QUIC  | `quic://juuri.hagezi.org`            | [Toevoegen aan AdGuard](adguard:add_dns_server?address=quic://juuri.hagezi.org&name=juuri.hagezi.org), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=quic://juuri.hagezi.org&name=juuri.hagezi.org)                       |
...
| DNSCrypt, IPv4       | Provider: `2.dnscrypt-cert.ibksturm` IP: `213.196.191.96:8443`          | [Toevoegen aan AdGuard](sdns://AQcAAAAAAAAAEzIxMy4xOTYuMTkxLjk2Ojg0NDMgK374BJKvK0aJHWKjmXdkG8_X2KEoao_LALK_nK6PM_AYMi5kbnNjcnlwdC1jZXJ0Lmlia3N0dXJt)                                                                                        |
...
| DNS-over-TLS   | `tls://dot.seby.io`                                        | [Toevoegen aan AdGuard](adguard:add_dns_server?address=tls://dot.seby.io&name=tls://dot.seby.io), [Toevoegen aan AdGuard VPN](adguardvpn:add_dns_server?address=tls://dot.seby.io&name=tls://dot.seby.io) |

### uBlock DNS

uBlock DNS is een advertentieblokkerende DNS-service. Het is gratis, open-source en aanpasbaar. Het bevat een online dashboard waarvoor je geen e-mailadres of wachtwoord nodig hebt om toegang te krijgen. uBlock DNS is niet verbonden aan uBlock Origin.

uBlock DNS biedt geen openbare DNS-adressen. Om het te gebruiken, moet je een persoonlijke accountsleutel genereren en je eigen eindpunt configureren.

Voorbeeld (zonder dashboard-toegang):

`DoH: https://example.ublock.dns/`

> Dit is een voorbeeld van een eindpunt. Om uBlock DNS met volledige functionaliteit te gebruiken, moet je jouw eigen accountsleutel aanmaken.
