...
3. Set the `http.address` setting to a new network interface. 예를 들어:
...
3. Add the required firewall rules in order to make it reachable through the network. 예를 들어:
...
6. Replace the old AdGuard Home executable file with the new one. 예를 들어:
