...
![자녀 보호](https://cdn.adtidy.org/public/Adguard/Blog/private_adguard_dns/parental_control.png)
...
![인증이 있는 DNS-over-HTTPS](https://cdn.adtidy.org/content/release_notes/dns/v2-7/http-auth/http-auth-en.png)
...
[사용자 정의 도메인](/private-dns/server-and-settings/custom-domains.md)
