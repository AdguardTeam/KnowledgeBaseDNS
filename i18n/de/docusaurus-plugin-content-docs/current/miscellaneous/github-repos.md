---
title: AdGuard DNS’s GitHub repositories
sidebar_position: 6
---
...
This article lists AdGuard DNS-related repositories, summarizes the purpose of each one, and gives a simple breakdown of what users can do there. You can also check a [list of all AdGuard’s core GitHub repositories and a guide on how to use them](https://adguard.com/kb/general/github-repos/).
...
As part of our commitment to transparency, we host all legal documents — such as End-User License Agreements, Privacy Policies, and Terms and Conditions — on GitHub. The [`adguard-dns.io` folder](https://github.com/AdguardTeam/LegalDocs/tree/master/adguard-dns.io) in our _LegalDocs_ repo lets anyone check the full history of changes to AdGuard DNS-related documents.
...
Repository of AdGuard DNS CLI — a cross-platform lightweight DNS client for AdGuard DNS. Er fungiert als DNS-Server, der DNS-Anfragen an die entsprechenden vorgelagerten Resolver weiterleitet.
