...
[FutureDNS](https://futuredns.eu.org) is a privacy-focused DNS service that blocks ads, trackers, and malware. Es unterstützt sowohl Standard-DNS als auch verschlüsselte Protokolle und verfolgt dabei eine strikte Keine-Protokollierung-Politik.
