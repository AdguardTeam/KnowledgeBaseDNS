...
6. Kopieren Sie eine der folgenden DNS-Adressen und fügen Sie sie in das Feld _DNS-Serveradresse_ in der App ein. Wenn Sie nicht sicher sind, welche Sie verwenden sollen, wählen Sie DNS-over-HTTPS.
...
7. Copy one of the following DNS addresses and paste it into the _DNS server addresses_ text field. Wenn Sie nicht sicher sind, welche Sie verwenden sollen, wählen Sie _DNS-over-HTTPS_.
...
Ein iOS-Geräteprofil, auch als "Konfigurationsprofil" von Apple bezeichnet, ist eine für den Zertifikateinsatz signierte XML-Datei, die Sie manuell auf Ihrem iOS-Gerät installieren oder über eine MDM-Lösung bereitstellen können. It also allows you to configure Private AdGuard DNS on your device.
