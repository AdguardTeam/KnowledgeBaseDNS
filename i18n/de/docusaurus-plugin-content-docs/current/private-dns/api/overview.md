...
| **client_id**               | Ja           | Your registered OAuth2 client identifier |
| **redirect_uri**            | Ja           | Where to redirect after authorization    |
| **state**                   | Ja           | Random string to prevent CSRF            |
| **code_challenge**          | Ja           | BASE64URL(SHA256(code_verifier))         |
| **code_challenge_method** | Ja           | Must be `S256`                           |
...
| Parameter         | Erforderlich | Beschreibung                                   |
|:----------------- |:------------ |:---------------------------------------------- |
| **grant_type**    | Ja           | Must be `authorization_code`                   |
| **code**          | Ja           | Authorization code received in Step 2          |
| **client_id**     | Ja           | Your registered OAuth2 client identifier       |
| **code_verifier** | Ja           | The original code verifier generated in Step 1 |
| **redirect_uri**  | Ja           | Must match the `redirect_uri` used in Step 2   |
