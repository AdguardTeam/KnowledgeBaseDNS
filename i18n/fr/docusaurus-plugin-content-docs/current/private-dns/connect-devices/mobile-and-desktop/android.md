...
1. [Téléchargez l'application AdGuard DNS](https://agrd.io/android_dns).

2. Allez sur votre tableau de bord DNS AdGuard à [adguard-dns.io/dashboard](https://adguard-dns.io/dashboard/).

3. Cliquez sur _Connecter l'appareil_ dans l'onglet _Accueil_.
...
5. Développez la section _Utiliser les applications AdGuard_.
   ...
   ![Utiliser les applications AdGuard \*border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/UseAdGuardApps.png)

6. Sous _Utiliser l'application AdGuard DNS_, choisissez l'une de ces méthodes de configuration :
   ...
   - Copiez votre identifiant de configuration et collez-le directement dans l'application.
     ...
     ![Id de configuration \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/SetupID.png)

7. Appuyez sur _Continuer_ → _Se connecter_.

   ![Connecter \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/Connect.png)

8. Même en utilisant un protocole basé sur un VPN, vous devez autoriser la création d'un profil VPN avant d'être pleinement protégé. Pour cela, allez sur la page d’accueil de l’application, cliquez sur _Activer_ et suivez les instructions intégrées.

9. All done! Your device is successfully connected to AdGuard DNS. Cliquez sur _Activer_ chaque fois que vous souhaitez démarrer la protection.

   ![Activer \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/Protection.png)
...
7. Copiez l'une des adresses DNS suivantes et collez-la dans le champ _Adresses des serveurs DNS_ dans l'application. Si vous n’êtes pas sûr de l’option à utiliser, sélectionnez \*DNS-over-HTTPS.
...
4. Tapez _Enregistrer_.
   ...
   C'est tout ! Your device is successfully connected to AdGuard DNS.
