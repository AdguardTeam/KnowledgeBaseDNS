...
EDNS Client Subnet is a method that includes components of end-user IP address data in requests that are sent to authoritative DNS servers. Il fournit une liste de blocage de sécurité, DNSSEC, sous-réseau client EDNS.
