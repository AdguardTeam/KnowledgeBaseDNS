...
Repository of AdGuard DNS CLI — a cross-platform lightweight DNS client for AdGuard DNS. Funguje jako DNS server, který předává požadavky DNS odpovídajícím odchozím řešitelům.
