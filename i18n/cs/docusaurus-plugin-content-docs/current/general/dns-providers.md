...
[BebasDNS](https://github.com/bebasid/bebasid) je bezplatný a neutrální veřejný řešitel se sídlem v Indonésii. Máme politiku nulových záznamů a podporujeme DNSSEC spolu s OpenNIC TLD. Pro běžný DNS podporujeme port 53 a 1753.
...
| Protokol       | Adresa                                                                   |                                                                                                                                                                                                                                                            |
| -------------- | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `103.87.68.194` a `34.101.185.130`                                       | [Přidat do AdGuardu](adguard:add_dns_server?address=103.87.68.194&name=), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=103.87.68.194&name=)                                                                                                   |
...
| DNS-over-QUIC  | `quic://quic.dns.bebasid.com:853`                                        | [Přidat do AdGuardu](adguard:add_dns_server?address=quic://quic.dns.bebasid.com:853&name=quic://quic.dns.bebasid.com:853), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=quic://quic.dns.bebasid.com:853&name=quic://quic.dns.bebasid.com:853) |
...
| DNSCrypt, IPv4 | Poskytovatel: `2.dnscrypt-cert.unfiltered.dns.bebasid.com` IP: `34.101.185.130:5443` | [Přidat do AdGuardu](sdns://AQcAAAAAAAAAEzM0LjEwMS4xODUuMTMwOjU0NDMghpbY0AAjPtvOiDsSzDh7Few4-cUrb6D33KwcMl75TtkqMi5kbnNjcnlwdC1jZXJ0LnVuZmlsdGVyZWQuZG5zLmJlYmFzaWQuY29t)                                                                                                          |
...
| Protokol       | Adresa                                                                         |                                                                                                                                                                                                                                                                                                    |
| -------------- | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `103.87.68.195`                                                                | [Přidat do AdGuardu](adguard:add_dns_server?address=103.87.68.195&name=), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=103.87.68.195&name=)                                                                                                                                           |
| DNS, IPv6      | `2a05:dfc7:bca0:beba:51d::5353`                                                | [Přidat do AdGuardu](adguard:add_dns_server?address=2a05:dfc7:bca0:beba:51d::5353&name=), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=2a05:dfc7:bca0:beba:51d::5353&name=)                                                                                                           |
...
| DNS-over-QUIC  | `quic://quic-antivirus.dns.bebasid.com:853`                                    | [Přidat do AdGuardu](adguard:add_dns_server?address=quic://quic-antivirus.dns.bebasid.com:853&name=quic://quic-antivirus.dns.bebasid.com:853), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=quic://quic-antivirus.dns.bebasid.com:853&name=quic://quic-antivirus.dns.bebasid.com:853) |
| DNSCrypt, IPv4 | Poskytovatel: `2.dnscrypt-cert.antivirus.bebasid.com` IP: `103.87.68.195:8443` | [Přidat do AdGuardu](sdns://AQMAAAAAAAAAEjEwMy44Ny42OC4xOTU6ODQ0MyDxbZzPMadetG2FodrzRfoiJjJi3cxbOsvKAvMyJ09rfiUyLmRuc2NyeXB0LWNlcnQuYW50aXZpcnVzLmJlYmFzaWQuY29t)                                                                                                                                  |
...
| Protokol       | Adresa                                                                             |                                                                                                                                                                                                                                                                                    |
| -------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `103.87.68.196`                                                                    | [Přidat do AdGuardu](adguard:add_dns_server?address=103.87.68.196&name=), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=103.87.68.196&name=)                                                                                                                           |
| DNS, IPv6      | `2a05:dfc7:bca0:b00b:beba::51d`                                                    | [Přidat do AdGuardu](adguard:add_dns_server?address=2a05:dfc7:bca0:b00b:beba::51d&name=), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=2a05:dfc7:bca0:b00b:beba::51d&name=)                                                                                           |
...
| DNS-over-QUIC  | `quic://quic-sehat.dns.bebasid.com:853`                                            | [Přidat do AdGuardu](adguard:add_dns_server?address=quic://quic-sehat.dns.bebasid.com:853&name=quic://quic-sehat.dns.bebasid.com:853), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=quic://quic-sehat.dns.bebasid.com:853&name=quic://quic-sehat.dns.bebasid.com:853) |
...
| DNS-over-QUIC  | `quic://zero.dns0.eu`          | [Přidat do AdGuardu](adguard:add_dns_server?address=quic://quic://zero.dns0.eu), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=quic://zero.dns0.eu)           |
