...
Toto je pouze jeden z dostupných serverů, úplný seznam najdete na [stránce veřejných serverů OpenNIC](https://servers.opennic.org/).
...
| DNS-over-TLS   | `tls://dot.seby.io`                                            | [Přidat do AdGuardu](adguard:add_dns_server?address=tls://dot.seby.io&name=tls://dot.seby.io), [Přidat do AdGuard VPN](adguardvpn:add_dns_server?address=tls://dot.seby.io&name=tls://dot.seby.io) |
