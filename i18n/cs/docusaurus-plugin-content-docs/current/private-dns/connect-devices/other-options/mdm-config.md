...
| **Zámek aplikace** (`lock_type`)          | Volitelné | Ne             | blokovat                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | Zamkne aplikaci AdGuard DNS, čímž zabrání uživateli zařízení v přístupu k aplikaci.                                                                                                                                              | Aplikace přejde do řízeného režimu; pokud je hodnota nastavena na `block`, aplikace se uzamkne.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Zamkne aplikaci, pokud je hodnota změněna na `block`; odemkne aplikaci, pokud je hodnota změněna na něco jiného nebo pokud je parametr smazán.                                                                                                                                                                                        | Aplikace není uzamčena, uživatel má přístup k aplikaci a jejím nastavením.                |
| **Typ instalace** (`installation_type`)   | Volitelné | Ne             | single_touch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Definuje průběh instalace aplikace. Při nastavení na `single_touch` aplikace automaticky provede nastavení zařízení bez interakce uživatele a zcela přeskočí proces registrace — uživatel pouze spustí aplikaci. | Aplikace přejde do řízeného režimu; pokud je zadáno `single_touch` spolu s platným `setup_id` (v případě ID nastavení zařízení) nebo s platným `setup_id` a `device_name` (v případě ID nastavení serveru), aplikace okamžitě přejde do automatického instalačního procesu; během nastavení a připojení aplikace se zobrazí obrazovka načítání; v případě úspěchu je automaticky přijata smlouva EULA, zavádění je označeno jako úspěšné a uživatel je přesměrován na hlavní obrazovku; v opačném případě se aplikace vrátí na obrazovku zavádění nebo na uzamčenou obrazovku (pokud je nastaveno `lock_type`). | Po dokončení počáteční instalace se nic nezměnilo.                                                                                                                                                                                                                                                                                    | Používá se standardní manuální postup zavádění.                                           |
| **EULA přijata** (`eula_accepted`)        | Boolean   | Ne             | true, false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Automaticky přijímá licenční smlouvu s koncovým uživatelem jménem uživatele a přeskočí obrazovku s souhlasem s licenční smlouvou během spuštění aplikace.                                                                        | Aplikace přejde do spravovaného režimu; pokud je hodnota `true`, EULA se označí jako přijatá a obrazovka EULA se během registrace přeskočí a uživatel přejde přímo na obrazovku nastavení; toto nastavení se použije jednou při každém spuštění aplikace.                                                                                                                                                                                                                                                                                                                                                                                                                | Nic se neděje.                                                                                                                                                                                                                                                                                                                        | Uživatel musí během registrace ručně přijmout smlouvu EULA.                               |
| **Statistiky povoleny** (`stats_enabled`) | Boolean   | Ne             | true, false.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Ovládá, zda jsou povolena hlášení o selhání a statistiky používání aplikací, což správcům umožňuje vzdáleně spravovat předvolby telemetrie.                                                                                      | Aplikace přejde do spravovaného režimu; pokud je zadáno, předvolba hlášení o selhání se nastaví na zadanou hodnotu a přepíše jakékoli předchozí volby uživatele; použije se pouze v případě, že je nastaveno `installation_type` **nebo** `eula_accepted` je `true`; nastavení se použije jednou při každém spuštění aplikace.                                                                                                                                                                                                                                                                                                                                           | Povolí nastavení, když se hodnota změní na „true“; zakáže nastavení, když se hodnota změní na „false“.                                                                                                                                                                                                                                | Stávající preference uživatele zůstávají zachovány; uživatel může nastavení změnit ručně. |

:::info

Parametr `installation_type` má vyšší prioritu než `eula_accepted`. Pokud jsou zadány oba parametry, instalační proces sám zpracuje přijetí smlouvy EULA a parametr `eula_accepted` je ignorován.
