...
På iOS bruger AdGuard DNS en DNS-proxy til at håndhæve DNS-politikker og forblive **altid slået til** på overvågede enheder. For at aktivere dette, opret en `mobileconfig` til enheden og distribuér den via MDM.
