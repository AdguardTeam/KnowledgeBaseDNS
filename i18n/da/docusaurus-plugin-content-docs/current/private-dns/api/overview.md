...
For at tilgå dette endepunkt, kontakt os via **b2b@adguard.com**. Beskriv venligst årsagen til og brugstilfælde for dette endepunkt, samt angiv omdirigerings-URI'en. Efter godkendelse fremsendes en unik klientidentifikator til brug for parameteren **client_id**.
...
For at tilgå dette endepunkt, kontakt os via **b2b@adguard.com**. Beskeden bedes beskrive årsagen til og anvendelsestilfældene for dette endepunkt samt angive omdirigerings-URI'en. Efter godkendelsen modtages en unik klientidentifikator til brug i parameteren **client_id**.
...
Se [API-referencen](private-dns/api/reference.mdx).
