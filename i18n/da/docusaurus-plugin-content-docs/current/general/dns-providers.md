...
Disse er DNS-opløsere, som normalt drives af entusiaster eller små grupper. Selvom de måske ikke har samme omfang og redundans som større udbydere, prioriterer de ofte fortrolighed/transparens eller tilbyder særlige funktioner.
...
[DNS Forge](https://dnsforge.de/) er en redundant DNS-opløser leveret af [adminforge](https://adminforge.de/) med adblocker og uden logning.
