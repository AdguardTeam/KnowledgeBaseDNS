...
[BebasDNS](https://github.com/bebasid/bebasid) er en gratis og neutral offentlig opløser baseret i Indonesien. Vi haren nul log-politik og understøtter DNSSEC sammen med OpenNIC TLD. Vi understøtter både port 53 og 1753 til alm. DNS.
...
| Protokol       | Adresse                                                             |                                                                                                                                                                                                                                                       |
| -------------- | ------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `103.87.68.194` og `34.101.185.130`                                 | [Føj til AdGuard](adguard:add_dns_server?address=103.87.68.194&name=), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=103.87.68.194&name=)                                                                                                   |
...
| DNS-over-QUIC  | `quic://quic.dns.bebasid.com:853`                                   | [Føj til AdGuard](adguard:add_dns_server?address=quic://quic.dns.bebasid.com:853&name=quic://quic.dns.bebasid.com:853), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=quic://quic.dns.bebasid.com:853&name=quic://quic.dns.bebasid.com:853) |
...
| DNSCrypt, IPv4 | Udbyder: `2.dnscrypt-cert.unfiltered.dns.bebasid.com` IP: `34.101.185.130:5443` | [Føj til AdGuard](sdns://AQcAAAAAAAAAEzM0LjEwMS4xODUuMTMwOjU0NDMghpbY0AAjPtvOiDsSzDh7Few4-cUrb6D33KwcMl75TtkqMi5kbnNjcnlwdC1jZXJ0LnVuZmlsdGVyZWQuZG5zLmJlYmFzaWQuY29t)                                                                                                        |
...
| Protokol       | Adresse                                                                   |                                                                                                                                                                                                                                                                                               |
| -------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `103.87.68.195`                                                           | [Føj til AdGuard](adguard:add_dns_server?address=103.87.68.195&name=), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=103.87.68.195&name=)                                                                                                                                           |
| DNS, IPv6      | `2a05:dfc7:bca0:beba:51d::5353`                                           | [Føj til AdGuard](adguard:add_dns_server?address=2a05:dfc7:bca0:beba:51d::5353&name=), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=2a05:dfc7:bca0:beba:51d::5353&name=)                                                                                                           |
...
| DNS-over-QUIC  | `quic://quic-antivirus.dns.bebasid.com:853`                               | [Føj til AdGuard](adguard:add_dns_server?address=quic://quic-antivirus.dns.bebasid.com:853&name=quic://quic-antivirus.dns.bebasid.com:853), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=quic://quic-antivirus.dns.bebasid.com:853&name=quic://quic-antivirus.dns.bebasid.com:853) |
| DNSCrypt, IPv4 | Udbyder: `2.dnscrypt-cert.antivirus.bebasid.com` IP: `103.87.68.195:8443` | [Føj til AdGuard](sdns://AQMAAAAAAAAAEjEwMy44Ny42OC4xOTU6ODQ0MyDxbZzPMadetG2FodrzRfoiJjJi3cxbOsvKAvMyJ09rfiUyLmRuc2NyeXB0LWNlcnQuYW50aXZpcnVzLmJlYmFzaWQuY29t)                                                                                                                                |
...
| Protokol       | Adresse                                                                       |                                                                                                                                                                                                                                                                               |
| -------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `103.87.68.196`                                                               | [Føj til AdGuard](adguard:add_dns_server?address=103.87.68.196&name=), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=103.87.68.196&name=)                                                                                                                           |
| DNS, IPv6      | `2a05:dfc7:bca0:b00b:beba::51d`                                               | [Føj til AdGuard](adguard:add_dns_server?address=2a05:dfc7:bca0:b00b:beba::51d&name=), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=2a05:dfc7:bca0:b00b:beba::51d&name=)                                                                                           |
...
| DNS-over-QUIC  | `quic://quic-sehat.dns.bebasid.com:853`                                       | [Føj til AdGuard](adguard:add_dns_server?address=quic://quic-sehat.dns.bebasid.com:853&name=quic://quic-sehat.dns.bebasid.com:853), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=quic://quic-sehat.dns.bebasid.com:853&name=quic://quic-sehat.dns.bebasid.com:853) |
...
Et åbent samarbejdsprojekt til fremme, implementering og udbredelse af [DNS-fortrolighed](https://dnsprivacy.org/).
...
[DNSPod Public DNS+](https://www.dnspod.com/) er en fortrolighedsvenlig DNS-udbyder med mange års erfaring inden for udvikling af domænenavnsopløsningstjenester, hvis formål er at give brugerne en hurtigere, mere præcis og stabil rekursiv opløsningstjeneste.
...
[DNSWatchGO](https://www.watchguard.com/wgrd-products/dnswatchgo) er en DNS-tjeneste fra WatchGuard, der forhindrer folk i at interagere med skadeligt indhold.
...
[Google DNS](https://developers.google.com/speed/public-dns/) er en gratis alternativ global DNS-opløsningstjeneste.
...
| Protokol  | Adresse                                |                                                                                                                                                         |
| --------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4 | `156.154.70.4` and `156.154.71.4`      | [Føj til AdGuard](adguard:add_dns_server?address=156.154.70.4&name=), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=156.154.70.4&name=)       |
...
[OpenBLD.net DNS](https://openbld.net/) - Anycast/GeoDNS DNS-over-HTTPS, DNS-over-TLS resolvers with blocking: advertising, tracking, adware, malware, malicious activities and phishing companies, blocks ~1M domains. Kan opbevare 24/48 timers logger mhp. DDoS-/Oversvømmelsesangrebsafbødning.
...
[Digitale Gesellschaft](https://www.digitale-gesellschaft.ch/dns/) er en offentlig opløser drevet af Digital Society. Hosted i Zurich, Schweiz.
...
Dette er blot en af de tilgængelige servere, den komplette liste findes [hér](https://servers.opennic.org/).
...
[Captnemo DNS](https://captnemo.in/dnscrypt/) er en server, der kører fra en Digital Ocean-droplet i BLR1-regionen. Vedligeholdes af Abhay Rana alias Nemo.
...
[DNS Forge](https://dnsforge.de/) er en redundant DNS-opløser med en adblocker og ingen logning leveret af [adminforge](https://adminforge.de/).
...
| DNS-over-HTTPS | `https://doh.tiarap.org/dns-query` (cached via third-party)               | [Føj til AdGuard](adguard:add_dns_server?address=https://doh.tiarap.org/dns-query&name=doh.tiarap.org), [Føj til AdGuard VPN](adguardvpn:add_dns_server?address=https://doh.tiarap.org/dns-query&name=doh.tiarap.org) |
