...
Repository of AdGuard DNS CLI — a cross-platform lightweight DNS client for AdGuard DNS. Funziona come un server DNS che inoltra le richieste DNS ai resolver upstream corrispondenti.
