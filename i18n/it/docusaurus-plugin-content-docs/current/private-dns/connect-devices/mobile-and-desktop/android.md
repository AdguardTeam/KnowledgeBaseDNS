...
1. [Scarica l'app AdGuard DNS](https://agrd.io/android_dns).
...
5. Espandi la sezione _Usa le app AdGuard_.
   ...
   ![Usa app AdGuard \*border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/UseAdGuardApps.png)

6. In _Usa l'app DNS AdGuard_, scegli uno di questi metodi di approntamento:
   ...
   - Copia l'ID di configurazione e incollalo direttamente nell'app.

     ![ID di configurazione \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/SetupID.png)

7. Tocca _Continua_ → _Connetti_.

   ![Connetti \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/Connect.png)

8. Quando si utilizza un protocollo basato su VPN, è comunque necessario consentire la creazione di un profilo VPN prima di essere completamente protetti. Per farlo, vai nella pagine iniziale dell'app, clicca su _Abilita_ e segui le istruzioni in-app.

9. All done! Your device is successfully connected to AdGuard DNS. Clicca _Abilita_ ogni volta che vuoi avviare la protezione.

   ![Abilita \*mobile_border](https://cdn.adtidy.org/content/release_notes/dns/dns-app-v1-0/Protection.png)
...
4. Tocca _Salva_.
   ...
   Tutto fatto! Your device is successfully connected to AdGuard DNS.
