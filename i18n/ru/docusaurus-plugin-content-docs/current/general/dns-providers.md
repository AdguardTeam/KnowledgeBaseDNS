...
[Surfshark DNS](https://dns.surfsharkdns.com/) — это DNS-сервис, который не логирует, не отслеживает и не продает ваши данные. Surfshark’s global infrastructure ensures stable and consistent speeds.
