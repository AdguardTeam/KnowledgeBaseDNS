...
[Surfshark DNS](https://dns.surfsharkdns.com/) — это DNS-сервис, который не логирует, не отслеживает и не продаёт ваши данные. Глобальная инфраструктура Surfshark обеспечивает стабильную и постоянную скорость.

| Протокол       | Адрес                                    |                                                                                                                                                                                                                                                     |
| -------------- | ---------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `194.169.169.169`                        | [Добавить в AdGuard](adguard:add_dns_server?address=194.169.169.169&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=194.169.169.169&name=)                                                                                       |
| DNS, IPv6      | `2a09:a707:169::`                        | [Добавить в AdGuard](adguard:add_dns_server?address=2a09:a707:169::&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a09:a707:169::&name=)                                                                                       |
| DNS-over-HTTPS | `https://dns.surfsharkdns.com/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://dns.surfsharkdns.com/dns-query&name=dns.surfsharkdns.com), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://dns.surfsharkdns.com/dns-query&name=dns.surfsharkdns.com) |
| DNS-over-TLS   | `tls://dns.surfsharkdns.com`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://dns.surfsharkdns.com&name=dns.surfsharkdns.com), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://dns.surfsharkdns.com&name=dns.surfsharkdns.com)                         |
| DNS-over-QUIC  | `quic://dns.surfsharkdns.com`            | [Добавить в AdGuard](adguard:add_dns_server?address=quic://dns.surfsharkdns.com&name=dns.surfsharkdns.com), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=quic://dns.surfsharkdns.com&name=dns.surfsharkdns.com)                       |
...
### v.recipes DNS (ранее 0ms.dev)

[v.recipes DNS](https://v.recipes/dns/) — бесплатный глобальный DNS-сервис 0ms Group, который можно использовать в качестве альтернативы текущему DNS-провайдеру.

Он разработан с различными оптимизациями, такими как HTTP/3, кеширование и многое другое. Он использует машинное обучение для защиты пользователей от потенциальных угроз безопасности, а также оптимизирует свою работу с течением времени. Некоторые пользователи могли видеть, как DNS обрабатывает запросы в режиме реального времени на странице статистики, но в настоящее время страница статистики временно отключена. Даже если страница статистики временно отключена, сам DNS по-прежнему способен нормально обслуживать запросы пользователей.

| Протокол       | Адрес                         |                                                                                                                                                                                                         |
| -------------- | ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://v.recipes/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://v.recipes/dns-query&name=v.recipes), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://v.recipes/dns-query&name=v.recipes) |
...
| DNS-over-TLS   | Имя хоста: `wikimedia-dns.org` IP-адрес: `185.71.138.138` и IPv6: `2001:67c:930::1` | [Добавить в AdGuard](adguard:add_dns_server?address=tls://wikimedia-dns.org&name=wikimedia-dns.org), [Добавить в AdGuard VPN](adguard:add_dns_server?address=tls://wikimedia-dns.org&name=wikimedia-dns.org)                            |
...
ByteDance Public DNS — это бесплатный альтернативный DNS-сервис ByteDance в Китае. Единственный DNS, предоставляемый ByteDance в настоящее время, который поддерживает IPV4. Скоро будут запущены DOH, DOT, DOQ и другие сервисы зашифрованного DNS.
...
[Comss.one DNS](https://www.comss.ru/page.php?id=7315) — это быстрый и безопасный DNS-сервис на основе SmartDNS с доступом к ИИ-сервисам, защитой от рекламы, слежки, фишинга и вредоносных сайтов. Он поддерживает шифрование запросов DNS-over-HTTPS, DNS-over-TLS и DNS-over-QUIC.

#### Обход геоблокировки

Доступ к ИИ, блокировка фишинговых и вредоносных сайтов.

| Протокол       | Адрес                               |                                                                                                                                                                                                                         |
| -------------- | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `83.220.169.155` и `212.109.195.93` | [Добавить в AdGuard](adguard:add_dns_server?address=83.220.169.155&name=dns.comss.one), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=212.109.195.93&name=dns.comss.one)                                   |
...
| DNS-over-QUIC  | `quic://dns.comss.one`              | [Добавить в AdGuard](adguard:add_dns_server?address=quic://dns.comss.one&name=dns.comss.one), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=quic://dns.comss.one&name=dns.comss.one)                       |

#### Обход геоблокировки с фильтрацией рекламы

Доступ к ИИ, блокировка рекламы, счётчиков, фишинговых и вредоносных сайтов.

| Протокол       | Адрес                                |                                                                                                                                                                                                                                     |
| -------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `195.133.25.16`                      | [Добавить в AdGuard](adguard:add_dns_server?address=195.133.25.16&name=router.comss.one), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=195.133.25.16&name=router.comss.one)                                           |
| DNS-over-HTTPS | `https://router.comss.one/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://router.comss.one/dns-query&name=router.comss.one), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://router.comss.one/dns-query&name=router.comss.one) |
| DNS-over-TLS   | `tls://router.comss.one`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://router.comss.one&name=router.comss.one), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://router.comss.one&name=router.comss.one)                         |
| DNS-over-QUIC  | `quic://router.comss.one`            | [Добавить в AdGuard](adguard:add_dns_server?address=quic://router.comss.one&name=router.comss.one), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=quic://router.comss.one&name=router.comss.one)                       |

### CZ.NIC ODVR

[CZ.NIC ODVR](https://www.nic.cz/odvr/) CZ.NIC ODVR — это открытые проверяющие преобразователи DNSSEC. CZ.NIC не собирает личные данные и информацию на страницах, где устройства отправляют личные данные.
...
[Digitale Gesellschaft](https://www.digitale-gesellschaft.ch/dns/) — это публичный резолвер Digital Society. Проводится в Цюрихе, Швейцария.
...
[DNS4EU](https://www.joindns4.eu) - это бесплатный, ориентированный на конфиденциальность и безопасный DNS-резолвер, предназначенный для защиты граждан Европейского союза. Софинансируется Европейским союзом.

#### Защитное решение

Блокирует доступ к известным вредоносным и мошенническим сайтам.

| Протокол       | Адрес                                               |                                                                                                                                                                                                                 |
| -------------- | --------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `86.54.11.1` и `86.54.11.201`                       | [Добавить в AdGuard](adguard:add_dns_server?address=86.54.11.1&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=86.54.11.1&name=)                                                             |
| DNS, IPv6      | `2a13:1001::86:54:11:1` и `2a13:1001::86:54:11:201` | [Добавить в AdGuard](adguard:add_dns_server?address=2a13:1001::86:54:11:1&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:1&name=)                                       |
| DNS-over-HTTPS | `https://protective.joindns4.eu/dns-query`          | [Добавить в AdGuard](adguard:add_dns_server?address=https://protective.joindns4.eu/dns-query&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://protective.joindns4.eu/dns-query&name=) |
| DNS-over-TLS   | `tls://protective.joindns4.eu`                      | [Добавить в AdGuard](adguard:add_dns_server?address=tls://protective.joindns4.eu&name=DNS4EU), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://protective.joindns4.eu&name=DNS4EU)             |

#### Защитное решение с защитой детей

Помимо защитной функциональности, ограничивает доступ к сайтам, неподходящим для детей, например, содержащим откровенный контент, сцены насилия или информацию о наркотиках.

| Протокол       | Адрес                                                |                                                                                                                                                                                                       |
| -------------- | ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `86.54.11.12` и `86.54.11.212`                       | [Добавить в AdGuard](adguard:add_dns_server?address=86.54.11.12&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=86.54.11.12&name=)                                                 |
| DNS, IPv6      | `2a13:1001::86:54:11:12` и `2a13:1001::86:54:11:212` | [Добавить в AdGuard](adguard:add_dns_server?address=2a13:1001::86:54:11:12&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:12&name=)                           |
| DNS-over-HTTPS | `https://child.joindns4.eu/dns-query`                | [Добавить в AdGuard](adguard:add_dns_server?address=https://child.joindns4.eu/dns-query&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://child.joindns4.eu/dns-query&name=) |
| DNS-over-TLS   | `tls://child.joindns4.eu`                            | [Добавить в AdGuard](adguard:add_dns_server?address=tls://child.joindns4.eu&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://child.joindns4.eu&name=)                         |

#### Защитное решение с блокировкой рекламы

Скрывает рекламу на сайтах и в приложениях в дополнение к защитной функциональности.

| Протокол       | Адрес                                                |                                                                                                                                                                                                       |
| -------------- | ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `86.54.11.13` и `86.54.11.213`                       | [Добавить в AdGuard](adguard:add_dns_server?address=86.54.11.13&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=86.54.11.13&name=)                                                 |
| DNS, IPv6      | `2a13:1001::86:54:11:13` и `2a13:1001::86:54:11:213` | [Добавить в AdGuard](adguard:add_dns_server?address=2a13:1001::86:54:11:13&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:13&name=)                           |
| DNS-over-HTTPS | `https://noads.joindns4.eu/dns-query`                | [Добавить в AdGuard](adguard:add_dns_server?address=https://noads.joindns4.eu/dns-query&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://noads.joindns4.eu/dns-query&name=) |
| DNS-over-TLS   | `tls://noads.joindns4.eu`                            | [Добавить в AdGuard](adguard:add_dns_server?address=tls://noads.joindns4.eu&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://noads.joindns4.eu&name=)                         |

#### Защитное решение с защитой детей и блокировкой рекламы

Помимо блокировки вредоносных и мошеннических сайтов, блокирует доступ к сайтам, неподходящим для детей, например, содержащим откровенный контент, сцены насилия или наркотики. Плюс фильтрует рекламу.

| Протокол       | Адрес                                                |                                                                                                                                                                                                                   |
| -------------- | ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `86.54.11.11` и `86.54.11.211`                       | [Добавить в AdGuard](adguard:add_dns_server?address=86.54.11.11&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=86.54.11.11&name=)                                                             |
| DNS, IPv6      | `2a13:1001::86:54:11:11` и `2a13:1001::86:54:11:211` | [Добавить в AdGuard](adguard:add_dns_server?address=2a13:1001::86:54:11:11&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:11&name=)                                       |
| DNS-over-HTTPS | `https://child-noads.joindns4.eu/dns-query`          | [Добавить в AdGuard](adguard:add_dns_server?address=https://child-noads.joindns4.eu/dns-query&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://child-noads.joindns4.eu/dns-query&name=) |
| DNS-over-TLS   | `tls://child-noads.joindns4.eu`                      | [Добавить в AdGuard](adguard:add_dns_server?address=tls://child-noads.joindns4.eu&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://child-noads.joindns4.eu&name=)                         |

#### Решение без фильтрации

Вариант без фильтрации подходит тем пользователям, которые уверены в безопасности своих устройств и соединения и ищут быстрый, надёжный и анонимный сервис.

| Протокол       | Адрес                                                 |                                                                                                                                                                                                                   |
| -------------- | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `86.54.11.100` и `86.54.11.200`                       | [Добавить в AdGuard](adguard:add_dns_server?address=86.54.11.100&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=86.54.11.100&name=)                                                           |
| DNS, IPv6      | `2a13:1001::86:54:11:100` и `2a13:1001::86:54:11:100` | [Добавить в AdGuard](adguard:add_dns_server?address=2a13:1001::86:54:11:100&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a13:1001::86:54:11:100&name=)                                     |
| DNS-over-HTTPS | `https://unfiltered.joindns4.eu/dns-query`            | [Добавить в AdGuard](adguard:add_dns_server?address=https://child-noads.joindns4.eu/dns-query&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://child-noads.joindns4.eu/dns-query&name=) |
| DNS-over-TLS   | `tls://child-noads.joindns4.eu`                       | [Добавить в AdGuard](adguard:add_dns_server?address=tls://child-noads.joindns4.eu&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://child-noads.joindns4.eu&name=)                         |
...
| DNS, IPv6      | `2400:7fc0:849e:200::8` и `2404:c2c0:85d8:901::8` | [Добавить в AdGuard](adguard:add_dns_server?address=2400:7fc0:849e:200::8&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2400:7fc0:849e:200::8&name=)                                                                       |
| DNS-over-HTTPS | `https://doh-pure.onedns.net/dns-query`           | [Добавить в AdGuard](adguard:add_dns_server?address=https://doh-pure.onedns.net/dns-query&name=doh-pure.onedns.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://doh-pure.onedns.net/dns-query&name=doh-pure.onedns.net) |
| DNS-over-TLS   | `tls://dot-pure.onedns.net`                       | [Добавить в AdGuard](adguard:add_dns_server?address=tls://dot-pure.onedns.net&name=dot-pure.onedns.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://dot-pure.onedns.net&name=dot-pure.onedns.net)                         |

#### Block Edition

| Протокол       | Адрес                                             |                                                                                                                                                                                                                             |
| -------------- | ------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `52.80.66.66` и `117.50.22.22`                    | [Добавить в AdGuard](adguard:add_dns_server?address=52.80.66.66&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=52.80.66.66&name=)                                                                       |
| DNS, IPv6      | `2400:7fc0:849e:200::4` и `2404:c2c0:85d8:901::4` | [Добавить в AdGuard](adguard:add_dns_server?address=2400:7fc0:849e:200::4&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2400:7fc0:849e:200::4&name=)                                                   |
| DNS-over-HTTPS | `https://doh.onedns.net/dns-query`                | [Добавить в AdGuard](adguard:add_dns_server?address=https://doh.onedns.net/dns-query&name=doh.onedns.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://doh.onedns.net/dns-query&name=doh.onedns.net) |
...
[UK DNS Privacy Project](https://dnsprivacy.org.uk) — это публичный DNS-сервис, базирующийся в Великобритании, без отслеживания и логирования, с включённым DNSSEC

| Протокол       | Адрес                                          |                                                                                                                                                                                                                                                           |
| -------------- | ---------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `209.250.227.42` и `64.176.190.82`             | [Добавить в AdGuard](adguard:add_dns_server?address=209.250.227.42&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=209.250.227.42&name=)                                                                                               |
| DNS, IPv6      | `2001:19f0:7400:13c7:5400:05ff:fe40:d1ad`      | [Добавить в AdGuard](adguard:add_dns_server?address=2001:19f0:7400:13c7:5400:05ff:fe40:d1ad&name=), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2001:19f0:7400:13c7:5400:05ff:fe40:d1ad&name=)                                             |
| DNS-over-HTTPS | `https://resolver.dnsprivacy.org.uk/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://resolver.dnsprivacy.org.uk/dns-query&name=dnsprivacy.org.uk), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://resolver.dnsprivacy.org.uk/dns-query&name=dnsprivacy.org.uk) |
| DNS-over-TLS   | `tls://resolver.dnsprivacy.org.uk`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://resolver.dnsprivacy.org.uk&name=dnsprivacy.org.uk), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://resolver.dnsprivacy.org.uk&name=dnsprivacy.org.uk)                         |

### Xstl DNS

[Xstl DNS](https://get.dns.seia.io/) — это публичный DNS-сервис, базирующийся в Южной Корее, который не регистрирует IP-адрес пользователя. Блокирует рекламу и трекеры.
...
| Протокол        | Адрес                                                                         |                                                                                                                                                                                                                         |
| --------------- | ----------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-TLS    | Имя хоста: `tls://dot.ffmuc.net`                                              | [Добавить в AdGuard](adguard:add_dns_server?address=tls://dot.ffmuc.net&name=dot.ffmuc.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://dot.ffmuc.net&name=dot.ffmuc.net)                         |
| DNS-over-HTTPS  | Имя хоста: `https://doh.ffmuc.net/dns-query`                                  | [Добавить в AdGuard](adguard:add_dns_server?address=https://doh.ffmuc.net/dns-query&name=doh.ffmuc.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://doh.ffmuc.net/dns-query&name=doh.ffmuc.net) |
| DNS-over-HTTP/3 | Имя хоста: `h3://doh.ffmuc.net/dns-query`                                     | [Добавить в AdGuard](adguard:add_dns_server?address=h3://doh.ffmuc.net/dns-query&name=doh.ffmuc.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=h3://doh.ffmuc.net/dns-query&name=doh.ffmuc.net)       |
| DNS-over-QUIC   | Имя хоста: `quic://doq.ffmuc.net`                                             | [Добавить в AdGuard](adguard:add_dns_server?address=quic://doq.ffmuc.net&name=doq.ffmuc.net), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=quic://doq.ffmuc.net&name=doq.ffmuc.net)                       |
...
| DNSCrypt, IPv4       | Провайдер: `2.dnscrypt-cert.ibksturm` IP-адрес: `213.196.191.96:8443`          | [Добавить в AdGuard](sdns://AQcAAAAAAAAAEzIxMy4xOTYuMTkxLjk2Ojg0NDMgK374BJKvK0aJHWKjmXdkG8_X2KEoao_LALK_nK6PM_AYMi5kbnNjcnlwdC1jZXJ0Lmlia3N0dXJt)                                                                                                   |
...
[NWPS.fi DNS](https://nwps.fi) предоставляет DoH- и DoT-резолверы с двумя уровнями фильтрации.
...
| Протокол       | Адрес                                 |                                                                                                                                                                                                                                         |
| -------------- | ------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://public.ns.nwps.fi/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://public.ns.nwps.fi/dns-query&name=public.ns.nwps.fi), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://public.ns.nwps.fi/dns-query&name=public.ns.nwps.fi) |
| DNS-over-TLS   | `tls://public.ns.nwps.fi`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://public.ns.nwps.fi&name=public.ns.nwps.fi), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://public.ns.nwps.fi&name=public.ns.nwps.fi)                         |
...
| Протокол       | Адрес                               |                                                                                                                                                                                                                                 |
| -------------- | ----------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://kids.ns.nwps.fi/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://kids.ns.nwps.fi/dns-query&name=kids.ns.nwps.fi), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://kids.ns.nwps.fi/dns-query&name=kids.ns.nwps.fi) |
| DNS-over-TLS   | `tls://kids.ns.nwps.fi`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://kids.ns.nwps.fi&name=kids.ns.nwps.fi), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://kids.ns.nwps.fi&name=kids.ns.nwps.fi)                         |

### ASTRACAT DNS

[ASTRACAT DNS](https://astracat.vercel.app/) — это DNS-резолвер, ориентированный на конфиденциальность, построенный на инфраструктуре Cloudflare и дата-центре ASTRACAT. Он отличается высокой скоростью, отсутствием логирования и цензуры, обеспечивая безопасное и надёжное разрешение DNS.

| Протокол       | Адрес                                                 |                                                                                                                                                                                                                                                                                                         |
| -------------- | ----------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS, IPv4      | `85.209.2.112`                                        | [Добавить в AdGuard](adguard:add_dns_server?address=85.209.2.112&name=ASTRACAT%20DNS), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=85.209.2.112&name=ASTRACAT%20DNS)                                                                                                                     |
| DNS-over-HTTPS | `https://frd4wvnobp.cloudflare-gateway.com/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://frd4wvnobp.cloudflare-gateway.com/dns-query&name=frd4wvnobp.cloudflare-gateway.com), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://frd4wvnobp.cloudflare-gateway.com/dns-query&name=frd4wvnobp.cloudflare-gateway.com) |
| DNS-over-TLS   | `tls://frd4wvnobp.cloudflare-gateway.com`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://frd4wvnobp.cloudflare-gateway.com&name=frd4wvnobp.cloudflare-gateway.com), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://frd4wvnobp.cloudflare-gateway.com&name=frd4wvnobp.cloudflare-gateway.com)                         |

### DNSGuard

[DNSGuard](https://dnsguard.pub) блокирует рекламу, отслеживание и вредоносное ПО и придерживается строгой политики отсутствия логов.

| Протокол       | Адрес                                |                                                                                                                                                                                                                     |
| -------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS 1, IPv4    | `62.192.153.242`                     | [Добавить в AdGuard](adguard:add_dns_server?address=62.192.153.242&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=62.192.153.242&name=DNSGUARD)                                         |
| DNS 2, IPv4    | `62.192.153.243`                     | [Добавить в AdGuard](adguard:add_dns_server?address=62.192.153.243&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=62.192.153.243&name=DNSGUARD)                                         |
| DNS 1, IPv6    | `2a0c:4ac1:29::2`                    | [Добавить в AdGuard](adguard:add_dns_server?address=2a0c:4ac1:29::2&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a0c:4ac1:29::2&name=DNSGUARD)                                       |
| DNS 2, IPv6    | `2a0c:4ac1:29::3`                    | [Добавить в AdGuard](adguard:add_dns_server?address=2a0c:4ac1:29::3&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=2a0c:4ac1:29::3&name=DNSGUARD)                                       |
| DNS-over-HTTPS | `https://dns.dnsguard.pub/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://dns.dnsguard.pub/dns-query&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://dns.dnsguard.pub/dns-query&name=DNSGUARD) |
| DNS-over-TLS   | `tls://dns.dnsguard.pub`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://dns.dnsguard.pub&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://dns.dnsguard.pub&name=DNSGUARD)                         |
| DNS-over-QUIC  | `quic://dns.dnsguard.pub`            | [Добавить в AdGuard](adguard:add_dns_server?address=quic://dns.dnsguard.pub&name=DNSGUARD), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=quic://dns.dnsguard.pub&name=DNSGUARD)                       |

### 18Bit DNS

[18Bit DNS](https://www.18bit.cn) — это бесплатный, зашифрованный публичный DNS-сервис для китайского региона, работающий уже много лет. Состоящий из более чем 10 эндпоинтов, он предоставляет пользователям Китайского региона быстрые, безопасные и приватные DNS-сервисы. Более того, у него имеется защита от вредоносного ПО и фишинга.

| Протокол       | Адрес                            |                                                                                                                                                                                                             |
| -------------- | -------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| DNS-over-HTTPS | `https://doh.18bit.cn/dns-query` | [Добавить в AdGuard](adguard:add_dns_server?address=https://doh.18bit.cn/dns-query&name=18bitDNS), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=https://doh.18bit.cn/dns-query&name=18bitDNS) |
| DNS-over-TLS   | `tls://dns.18bit.cn`             | [Добавить в AdGuard](adguard:add_dns_server?address=tls://dns.18bit.cn&name=18bitDNS), [Добавить в AdGuard VPN](adguardvpn:add_dns_server?address=tls://dns.18bit.cn&name=18bitDNS)                         |
