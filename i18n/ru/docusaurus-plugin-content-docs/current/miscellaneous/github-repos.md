...
Repository of AdGuard DNS CLI — a cross-platform lightweight DNS client for AdGuard DNS. Он работает как DNS-сервер, перенаправляющий DNS-запросы соответствующим upstream-резолверам.
