...
It means that you will need a server with a public dedicated IP address. There are plenty of cheap cloud servers providers: [DigitalOcean][digital-ocean], [Vultr][vultr], [Linode][linode], etc. Just choose one, create a cloud server there, and [install AdGuard Home](getting-started.md) on your server.
...
[reverse-proxy-faq]:      faq.md#reverseproxy
