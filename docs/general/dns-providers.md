...
[ASTRACAT DNS](https://astracat.ru/) — privacy-focused DNS resolver, ориентированный на высокую скорость, отсутствие логирования и цензуры. Обеспечивает безопасное и надёжное разрешение DNS-запросов.
