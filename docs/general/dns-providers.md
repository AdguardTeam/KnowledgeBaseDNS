...
| Protocol         | Address                                             |                |
|------------------|-----------------------------------------------------|----------------|
| DNS-over-HTTPS 1 | `https://frd4wvnobp.cloudflare-gateway.com/dns-query` | [Add to AdGuard](adguard:add_dns_server?address=https://frd4wvnobp.cloudflare-gateway.com/dns-query&name=ASTRACAT), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=https://frd4wvnobp.cloudflare-gateway.com/dns-query&name=ASTRACAT) |
| DNS-over-HTTPS 2 | `https://dns.astracat.ru/dns-query`                | [Add to AdGuard](adguard:add_dns_server?address=https://dns.astracat.ru/dns-query&name=ASTRACAT), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=https://dns.astracat.ru/dns-query&name=ASTRACAT) |
| DNS-over-TLS 1   | `tls://frd4wvnobp.cloudflare-gateway.com`          | [Add to AdGuard](adguard:add_dns_server?address=tls://frd4wvnobp.cloudflare-gateway.com&name=ASTRACAT), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=tls://frd4wvnobp.cloudflare-gateway.com&name=ASTRACAT) |
| DNS-over-TLS 2   | `tls://dns.astracat.ru`                             | [Add to AdGuard](adguard:add_dns_server?address=tls://dns.astracat.ru&name=ASTRACAT), [Add to AdGuard VPN](adguardvpn:add_dns_server?address=tls://dns.astracat.ru&name=ASTRACAT) |
