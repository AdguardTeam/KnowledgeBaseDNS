---
title: DNS Mobile App
sidebar_position: 4
---

To connect a new device to your DNS server using the AdGuard DNS mobile app:

1. Go to the **Dashboard** → [**Servers**](https://adguard-dns.io/dashboard/servers).
